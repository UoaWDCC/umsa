...
export default function Alanna() {
      ...
      <div className="bg-pink-600 p-20 w-full flex item-center justify-center rounded-lg">
        ...
        <div className="h-full max-w-[700px] flex flex-col">
          ...
          <div className="flex flex-col items-center mb-8">
            <h1 className="text-3xl font-bold italic mb-5">
              hi, my name is alanna :D
            </h1>
          </div>
          ...
          <div>
            <p className="text-sm mt-10">
              hey everyone :) i&apos;m super excited to be umsa&apos;s tech lead
              for 2026! <br /> a couple fun facts about me: i&apos;m a huge
              sitcom fan (how i met your mother!), movies, photography & murder
              mysteries. i love compsci because it lets me get creative, see how
              things work and meet super cool people :)) i&apos;m always down
              for a coffee/milk-tea/matcha run,, and love to yap about
              everything from world history to your latest travels & hobby
              findings.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex grid-cols-4 gap-4 mt-4">
              ...
              <a
                href="https://www.github.com/alannasantoso"
                target="_blank"
                rel="noopener noreferrer"
              >
