      ...
      <div className="bg-gray-800 p-20 w-full flex item-center justify-center rounded-lg">
        ...
        <div className="h-full max-w-[700px] flex flex-col">
          ...
          <div className="md:grid gap-10 item-center justify-center">
            ...
            <img
              src={TerrencePhoto}
              className="col-span-2 object-cover md:mb-0 mb-5 w-full rounded-2xl"
            />
            ...
            <div className="col-span-2 w-156 bg-gray-900 p-6 rounded-lg item-center justify-center">
              <MemberStatsTable
                stats={{
                  ...
                  favouriteFood:
                    "Fried Chicken, Burgers, Beef Noodles, everything but sea food",
                }}
              />
            </div>
          </div>
          ...
          <div className="md: grid gap-10 item-center justify-center">
            <p className="md:text-sm mt-10 bg-gray-900 p-4 rounded-lg">
              Temporary about me section Temporary about me section Temporary
              about me section Temporary about me section Temporary about me
              section Temporary about me section Temporary about me section
              Temporary about me section Temporary about me section Temporary
              about me section Temporary about me section Temporary about me
              section Temporary about me section Temporary about me section
              Temporary about me section Temporary about me section Temporary
              ...
              about me section Temporary about me section Temporary about me
              section Temporary about me section Temporary about me section
              Temporary about me section Temporary about me section
            </p>
          </div>

          {/* social media section */}
          <div>
            <h1 className="text-3xl mt-10 mb-5 font-bold text-left">
              Social Links:
            </h1>
            ...
            <div className="flex grid-cols-4 gap-4 mt-4">
              ...
              <a
                href="https://www.instagram.com/_tw1738"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/in/terrence-wu-5657a0376/"
                target="_blank"
                rel="noopener noreferrer"
              >
