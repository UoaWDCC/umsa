        ...
        <div className="h-full max-w-[700px] flex flex-col">
          ...
          <div>
            <p className="text-base mt-10">
              hi guyss i&apos;m so so excited to be a developer for WDCC&apos;s
              umsa project :p my fav hobbies are muay thai, music (drums,
              guitar, bass) and motorbikes (i ride to campus when its not
              raining :D) i&apos;m looking forward to working with all you
              guys!!!!
            </p>
          </div>

          <div>
            <h1 className="text-3xl my-10 font-bold italic text-center">
              here are my socials :D
            </h1>
            <div className="flex grid-cols-3 gap-4 mt-4 item-center justify-center">
              <a
                href="https://www.instagram.com/prunalee"
                target="_blank"
              ...
              <a
                href="https://www.github.com/nryuzl"
                target="_blank"
                rel="noopener noreferrer"
              >
              ...
              <a
                href="https://www.linkedin.com/in/pruna-lee-58114a292/"
                target="_blank"
                rel="noopener noreferrer"
              >
