      ...
      <div className="relative min-h-screen w-full flex flex-col items-center justify-center rounded-lg">
        ...
        <div className="relative h-full max-w-175 flex flex-col">
          ...
          <div className="md:grid grid-cols-3 flex flex-col w-full gap-10 items-center justify-center">
            ...
            <img
              src={AlexImage}
              className="col-span-1 object-cover w-full max-w-sm md:max-w-none h-full min-h-75 rounded-2xl shadow-lg shadow-xl/30"
            />
            ...
            <div className="col-span-2 w-full max-w-sm md:max-w-none flex flex-col bg-gray-900 p-6 rounded-lg shadow-lg shadow-xl/30">
              <MemberStatsTable
                stats={{
                  ...
                  year: "First year",
                  degree:
                    "compsci & IT management(im gonna drop this for Finance conjoint)",
                  typingSpeed: "16 wpm",
                  favouritePaper: "A4",
                  favouriteFood:
                    "3am maccas mish(Big Mac, 2 Cheeseburgers, medium fries, 6pcs chicken nugget with 2 sweet and sour sauce and medium Sprite zero)",
                }}
              />
            </div>
          </div>
          ...
          <div className="w-full mb-32">
            ...
            <a
              href="https://www.instagram.com/p/DXXXjSwxI9m"
              target="_blank"
              rel="noopener noreferrer"
            >
              <u>https://www.instagram.com/p/DXXXjSwxI9m</u>
            </a>
          </div>

          {/* social media section */}
          <div className="w-full flex flex-col items-center pt-20 mb-2">
            <h1 className="text-3xl mb-1 font-bold italic text-left">
              ✨Socials✨
            </h1>
            <div className="flex grid-cols-4 gap-4 mt-1">
              {/* the <a></a> tags are for creating links */}
              <a
                href="https://github.com/AiexProjects"
                target="_blank"
                rel="noopener noreferrer"
              >
              ...
              <a
                href="https://www.linkedin.com/in/alex-lee-571736358/"
                target="_blank"
                rel="noopener noreferrer"
              >
              ...
              <a
                href="https://www.instagram.com/aiex.lee/"
                target="_blank"
                rel="noopener noreferrer"
              >
              ...
              <a
                href="https://letterboxd.com/alexree121/"
                target="_blank"
                rel="noopener noreferrer"
              >
              ...
              <a
                href="https://open.spotify.com/user/cq4c5m8ihueunpkfykn1l3s2f"
                target="_blank"
                rel="noopener noreferrer"
              >
